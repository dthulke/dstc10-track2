...
class PretrainedDensityRatioMethodModel(PreTrainedModel):
    ...
    def __init__(
        ...
        # self._validate_configs_match(self.config, language_model.config)
    ...
    def forward(
        ...
        **unused,
        ...
        ilm_logits = self.internal_language_model(
            lm_input_ids,
            attention_mask=lm_attention_mask.to(self.internal_language_model.device),
