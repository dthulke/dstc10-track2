...
def main(argv):
    ...
    parser.add_argument('--dataset_filter_json', dest='dataset_filter_json', action='store',metavar='JSON_FILE',default=None)
    ...
    max_knowledge_length = max([len(pred['knowledge']) for pred in output if 'knowledge' in pred], default=0)
